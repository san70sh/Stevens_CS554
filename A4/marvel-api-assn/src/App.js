  ...
  return (
      <div className="place-content-center bg-red-700 text-white">
          ...
          <div className="flex flex-col items-center bg-red-800">
              <div>
                  <Link to={"characters"}><button type="button" className="rounded-lg mx-9 py-2 px-7 font-semibold bg-red-900">Characters</button></Link>
                  <Link to={"comics"}><button type="button" className="rounded-lg mx-20 py-2 px-9 font-semibold bg-red-900">Comics</button></Link>
                  <Link to={"series"}><button type="button" className="rounded-lg mx-10 py-2 px-9 font-semibold bg-red-900">Series</button></Link>
